...
LimitFrequencyHandler.version = "0.1.0" --优先级

function LimitFrequencyHandler:new()
    LimitFrequencyHandler.super.new(self, "limit_frequency-plugin", self.version)
    waf_log.debug_log("===========LimitFrequencyHandler.new============");
end

function LimitFrequencyHandler:access()
    LimitFrequencyHandler.super.access(self)
	waf_log.debug_log("===========LimitFrequencyHandler.access============");
